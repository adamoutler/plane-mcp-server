...
def register_read_tools(mcp: FastMCP) -> None:
    from plane_mcp.journey.cache import get_cached_states_string, get_cached_labels_string, get_cached_priorities_string
    slugs_doc = get_cached_project_slugs_docstring(full_descriptions=True)
    slugs_short = get_cached_project_slugs_docstring(full_descriptions=False)
    states_str = get_cached_states_string()
    labels_str = get_cached_labels_string()
    priorities_str = get_cached_priorities_string()
